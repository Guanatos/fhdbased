...
if (isset($_POST['nacl'])){
 if ( $_POST['nacl'] == md5(AUTH_KEY.$db->get_var("SELECT last_login FROM site_users WHERE user_id = $user_id;")) ) {
	...
	$db->query("INSERT INTO skills(skill_name,skill_desc)VALUES('$skill_name','$skill_desc',1);");
//$db->debug();
...
<form action="skills_register.php" method="post" class="form-horizontal" data-parsley-validate>
