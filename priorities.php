...
$myquery = "SELECT type_id, type, type_name FROM site_types WHERE type LIKE 2 ORDER BY type_name;";
...
//		echo "<td>$type_desc</td>\n";
		echo "<td align='center'><a href='mod_departments.php?type_id=$type_id&action=edit'><i class='glyphicon glyphicon-edit' title='edit'></i></a></td>\n";
       	$deletelink = "<a href='priorities.php?type_id=$type_id&action=delete&nacl=$nacl' onclick=\"return confirm('Are you sure you want to delete?')\"><i class='glyphicon glyphicon-remove-circle' title='delete'></i></a>";
