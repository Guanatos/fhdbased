...
CREATE TABLE `site_types` (
  ...
  `type_desc` tinytext COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `skills` (
  ...
  `skill_desc` varchar(200) COLLATE latin1_general_ci NOT NULL,
  `skill_pending` int(1) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`skill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='Staff''s Skills';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `user_skills` (
  `usr_skill_id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `skill_id` int(11) NOT NULL,
  `timestamp` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`usr_skill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci COMMENT='User''s Skills';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-06-17 21:53:21
