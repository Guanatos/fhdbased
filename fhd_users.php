...
$myquery = "SELECT user_id,user_login,user_name,user_email,user_pending,user_level,user_protect_edit,user_msg_send FROM site_users WHERE 1 $pending ORDER BY user_level,user_id ASC;";
